...
return array(
        ...
        "Remove Order" => "Remover ordena&ccedil;&atilde;o",
        "Remove Filters" => "Remover Filtros",
        "Remove Filters and Order" => "Remover Filtros e Ordena&ccedil;&atilde;o",
        "Page" => "P&aacute;gina",
        "Next" => "Próxima",
        "Last" => "Última",
        "First" => "Primeira",
    ...
    "Captcha value is wrong" => "A verifica&ccedil;&atilde;o est&aacute; incorreta",
	"Empty captcha value" => "A verifica&ccedil;&atilde;o est&aacute; vazia",
    ...
    "'%value%' contains non alphabetic characters" => "'%value%' cont&eacute;m caracteres n&atilde;o alfab&eacute;ticos",
    "'%value%' is an empty string" => "'%value%' &eacute; uma string vazia",

    // Zend_Validate_Barcode
    "'%value%' failed checksum validation" => "'%value%' falhou na valida&ccedil;&atilde;o do checksum",
    ...
    "'%value%' is not between '%min%' and '%max%', inclusively" => "'%value%' n&atilde;o est&aacute; entre '%min%' e '%max%', inclusivamente",
    "'%value%' is not strictly between '%min%' and '%max%'" => "'%value%' n&atilde;o est&aacute; exatamente entre '%min%' e '%max%'",

    // Zend_Validate_Callback
    "'%value%' is not valid" => "'%value%' n&atilde;o &eacute; v&aacute;lido",
    ...
    "'%value%' does not appear to be a valid date" => "'%value%' n&atilde;o parece ser uma data v&aacute;lida",
    "'%value%' does not fit the date format '%format%'" => "'%value%' n&atilde;o se encaixa no formato de data '%format%'",

    // Zend_Validate_Db_Abstract
    "No record matching %value% was found" => "N&atilde;o foram encontrados registros para %value%",
    ...
    "'%value%' contains not only digit characters" => "'%value%' n&atilde;o cont&eacute;m apenas números",
    "'%value%' is an empty string" => "'%value%' &eacute; uma string vazia",

    // Zend_Validate_EmailAddress
    "Invalid type given, value should be a string" => "Tipo especificado inv&aacute;lido, o valor deve ser uma string",
    "'%value%' is no valid email address in the basic format local-part@hostname" => "'%value%' n&atilde;o &eacute; um endere&ccedil;o de e-mail v&aacute;lido no formato local-part@hostname",
    "'%hostname%' is no valid hostname for email address '%value%'" => "'%hostname%' n&atilde;o &eacute; um nome de host v&aacute;lido para o endere&ccedil;o de e-mail '%value%'",
    "'%hostname%' does not appear to have a valid MX record for the email address '%value%'" => "'%hostname%' n&atilde;o parece ter um registro MX v&aacute;lido para o endere&ccedil;o de e-mail '%value%'",
    "'%hostname%' is not in a routable network segment. The email address '%value%' should not be resolved from public network." => "'%hostname%' n&atilde;o &eacute; um segmento de rede rote&aacute;vel. O endere&ccedil;o de e-mail '%value%' n&atilde;o deve ser resolvido a partir de um rede pública.",
    "'%localPart%' can not be matched against dot-atom format" => "'%localPart%' n&atilde;o corresponde com o formato dot-atom",
    "'%localPart%' can not be matched against quoted-string format" => "'%localPart%' n&atilde;o corresponde com o formato quoted-string",
    "'%localPart%' is no valid local part for email address '%value%'" => "'%localPart%' n&atilde;o &eacute; uma parte local v&aacute;lida para o endere&ccedil;o de e-mail '%value%'",
    ...
    "File '%value%' has a false extension" => "O arquivo '%value%' possui a extens&atilde;o incorreta",
    "File '%value%' could not be found" => "O arquivo '%value%' n&atilde;o pôde ser encontrado",

    // Zend_Validate_File_ExcludeMimeType
    "File '%value%' has a false mimetype of '%type%'" => "O arquivo '%value%' tem o mimetype incorreto: '%type%'",
    "The mimetype of file '%value%' could not be detected" => "O mimetype do arquivo '%value%' n&atilde;o pôde ser detectado",
    "File '%value%' can not be read" => "O arquivo '%value%' n&atilde;o pôde ser lido",

    // Zend_Validate_File_Exists
    "File '%value%' does not exist" => "O arquivo '%value%' n&atilde;o existe",
    ...
    "File '%value%' is not compressed, '%type%' detected" => "O arquivo '%value%' n&atilde;o est&aacute; compactado: '%type%' detectado",
    "The mimetype of file '%value%' could not be detected" => "O mimetype do arquivo '%value%' n&atilde;o pôde ser detectado",
    "File '%value%' can not be read" => "O arquivo '%value%' n&atilde;o pôde ser lido",

    // Zend_Validate_File_IsImage
    "File '%value%' is no image, '%type%' detected" => "O arquivo '%value%' n&atilde;o &eacute; uma imagem: '%type%' detectado",
    "The mimetype of file '%value%' could not be detected" => "O mimetype do arquivo '%value%' n&atilde;o pôde ser detectado",
    "File '%value%' can not be read" => "O arquivo '%value%' n&atilde;o pôde ser lido",
    ...
    "File '%value%' exceeds the defined ini size" => "O arquivo '%value%' excede o tamanho definido na configura&ccedil;&atilde;o",
    ...
    "File '%value%' was not uploaded" => "O arquivo '%value%' n&atilde;o foi enviado",
    ...
    // Zend_Validate_Float
    "Invalid type given, value should be float, string, or integer" => "Tipo especificado inv&aacute;lido, o valor deve ser float, string, ou inteiro",
    "'%value%' does not appear to be a float" => "'%value%' n&atilde;o parece ser um float",

    // Zend_Validate_GreaterThan
    "'%value%' is not greater than '%min%'" => "'%value%' n&atilde;o &eacute; maior que '%min%'",

    // Zend_Validate_Hex
    "Invalid type given, value should be a string" => "Tipo especificado inv&aacute;lido, o valor deve ser uma string",
    "'%value%' has not only hexadecimal digit characters" => "'%value%' n&atilde;o cont&eacute;m somente caracteres hexadecimais",

    // Zend_Validate_Hostname
    "Invalid type given, value should be a string" => "Tipo especificado inv&aacute;lido, o valor deve ser uma string",
    "'%value%' appears to be an IP address, but IP addresses are not allowed" => "'%value%' parece ser um endere&ccedil;o de IP, mas endere&ccedil;os de IP n&atilde;o s&atilde;o permitidos",
    ...
    "The token '%token%' does not match the given token '%value%'" => "A marca '%token%' n&atilde;o corresponde a marca '%value%' fornecida",
    "No token was provided to match against" => "Nenhuma marca foi fornecida para a compara&ccedil;&atilde;o",

    // Zend_Validate_InArray
    "'%value%' was not found in the haystack" => "'%value%' n&atilde;o faz parte dos valores esperados",
    ...
    "'%value%' does not appear to be an integer" => "'%value%' n&atilde;o parece ser um número inteiro",

    // Zend_Validate_Ip
    "Invalid type given, value should be a string" => "Tipo especificado inv&aacute;lido, o valor deve ser uma string",
    "'%value%' does not appear to be a valid IP address" => "'%value%' n&atilde;o parece ser um endere&ccedil;o de IP v&aacute;lido",

    // Zend_Validate_Isbn
    "'%value%' is no valid ISBN number" => "'%value%' n&atilde;o &eacute; um número ISBN v&aacute;lido",

    // Zend_Validate_LessThan
    "'%value%' is not less than '%max%'" => "'%value%' n&atilde;o &eacute; menor que '%max%'",
    ...
    "Value is required and can't be empty" => "O campo &eacute; obrigatório e n&atilde;o pode estar vazio",

    // Zend_Validate_PostCode
    "Invalid type given, value should be string or integer" => "Tipo especificado inv&aacute;lido, o valor deve ser string ou inteiro",
    "'%value%' does not appear to be an postal code" => "'%value%' n&atilde;o parece ser um código postal",

    // Zend_Validate_Regex
    "Invalid type given, value should be string, integer or float" => "Tipo especificado inv&aacute;lido, o valor deve ser string, inteiro ou float",
    "'%value%' does not match against pattern '%pattern%'" => "'%value%' n&atilde;o corresponde ao padr&atilde;o '%pattern%'",

    // Zend_Validate_Sitemap_Changefreq
    "'%value%' is no valid sitemap changefreq" => "'%value%' n&atilde;o &eacute; um changefreq de sitemap v&aacute;lido",

    // Zend_Validate_Sitemap_Lastmod
    "'%value%' is no valid sitemap lastmod" => "'%value%' n&atilde;o &eacute; um lastmod de sitemap v&aacute;lido",

    // Zend_Validate_Sitemap_Loc
    "'%value%' is no valid sitemap location" => "'%value%' n&atilde;o &eacute; uma localiza&ccedil;&atilde;o de sitemap v&aacute;lida",

    // Zend_Validate_Sitemap_Priority
    "'%value%' is no valid sitemap priority" => "'%value%' n&atilde;o &eacute; uma prioridade de sitemap v&aacute;lida",
