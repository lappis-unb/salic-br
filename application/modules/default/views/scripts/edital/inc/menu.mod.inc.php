...
<script type="text/javascript">
            ...
            function JSAdicionarReferenciaConteudoEdital() {
                ...
                conteudo += '       <option>Crit&eacute;rios de Admissibilidade</option>';
                conteudo += '       <option>Crit&eacute;rios de Participa&ccedil;&atilde;o</option>';
                conteudo += '       <option>Formas de Pagamento</option>';
                conteudo += '       <option>Question&aacute;rio</option>';
                conteudo += '       <option>Planilha Or&ccedil;ament&aacute;ria</option>';
                conteudo += '       <option>Portifólio</option>';
                conteudo += '       <option>Plano de Viagem</option>';
                conteudo += '       <option>Local de Realiza&ccedil;&atilde;o</option>';
                conteudo += '       <option>Benefici&aacute;rios</option>';
                conteudo += '    </select>';
                conteudo += '    </td>';
                conteudo += '</tr>';
                conteudo += '</table>';
            ...
            function JSAddCategoria(nomeCategoria) {
                ...
                if (numModulo) {
                    ...
                    conteudo += '  <a href="#" class="no_seta" onclick="JSMostaConteudo(\'informacoesGerais\',\'' + nomModulo + '\',\'' + nomeCategoria + '\' ); $(\'#displayModulo\').fadeIn();">Informa&ccedil;&otilde;es do gerais</a>';
                    conteudo += '  <a href="#" class="no_seta" onclick="JSMostaConteudo(\'criteriosAdmissibilidade\',\'' + nomModulo + '\',\'' + nomeCategoria + '\'); $(\'#displayModulo\').fadeIn();">Cirt&eacute;rios de admissibilidade</a>';
                    conteudo += '  <a href="#" class="no_seta" onclick="JSMostaConteudo(\'criteriosAvaliacao\',\'' + nomModulo + '\',\'' + nomeCategoria + '\'); $(\'#displayModulo\').fadeIn();">Cirt&eacute;rios de participa&ccedil;&atilde;o</a>';
                    ...
                    conteudo += '  <a href="#" class="no_seta" onclick="JSMostaConteudo(\'questionario\',\'' + nomModulo + '\',\'' + nomeCategoria + '\');  $(\'#displayModulo\').fadeIn();">Question&aacute;rio</a>';
                    conteudo += '  <a href="#" class="no_seta" class="last" onclick="JSMostaConteudo(\'planilhaOrcamentaria\',\'' + nomModulo + '\',\'' + nomeCategoria + '\');  $(\'#displayModulo\').fadeIn();">Planilha Or&ccedil;ament&aacute;ria</a>';
                    conteudo += '   </div>';
                    conteudo += '</div>';
