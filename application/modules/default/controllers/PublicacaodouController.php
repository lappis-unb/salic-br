...
//        $this->intTamPag = 10;
    ...
    public function gerarportariaAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            try {
                ...
                $this->view->cargo = strtoupper(strtr($cargo ,"&aacute;&eacute;&iacute;óúâêô&atilde;&otilde;&agrave;èìòù&ccedil;","&aacute;&eacute;ÍÓÚÂÊÔ&atilde;&otilde;&agrave;ÈÌÒÙ&ccedil;"));
                $this->view->nome = strtoupper(strtr($nm ,"&aacute;&eacute;&iacute;óúâêô&atilde;&otilde;&agrave;èìòù&ccedil;","&aacute;&eacute;ÍÓÚÂÊÔ&atilde;&otilde;&agrave;ÈÌÒÙ&ccedil;"));
    ...
    public function gerarArquivoRtfAction(){
        ...
        $this->view->cargo = strtoupper(strtr($dados->dsCargo ,"&aacute;&eacute;&iacute;óúâêô&atilde;&otilde;&agrave;èìòù&ccedil;","&aacute;&eacute;ÍÓÚÂÊÔ&atilde;&otilde;&agrave;ÈÌÒÙ&ccedil;"));
        $this->view->nome = strtoupper(strtr($nm ,"&aacute;&eacute;&iacute;óúâêô&atilde;&otilde;&agrave;èìòù&ccedil;","&aacute;&eacute;ÍÓÚÂÊÔ&atilde;&otilde;&agrave;ÈÌÒÙ&ccedil;"));
