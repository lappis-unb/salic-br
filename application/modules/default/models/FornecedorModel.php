...
class FornecedorModel extends Minc_Db_Table_Abstract
{
    ...
    {
        $select = "SELECT 'COTA��O' as Modalidade, b.idAgente,e.CNPJCPF,F.Descricao AS Fornecedor,c.idPlanilhaAprovacao,d.IdPRONAC
                ...
                UNION ALL
                SELECT 'LICITA�AO' as Modalidade, b.idAgente,e.CNPJCPF,F.Descricao AS Fornecedor,c.idPlanilhaAprovacao,d.IdPRONAC
